    ...
    public void createButtons() {
        ...
        testSave.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				testObject[0] = profile;
				testObject[1] = fridge.getFoods();
				testObject[2] = lunchBox.getFoods();
				testObject[3] = day.getDay();
				FileTools.writeObjectToFile(FileTools.DEFAULT_FILENAME, testObject);
			}
